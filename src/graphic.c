...
{
	if (game->wdir == DIR_E)
		game->data.img = mlx_xpm_file_to_image(game->data.mlx, "../textures/wall_e.xpm", &game->data.img_width, &game->data.img_height);
	else if (game->wdir == DIR_N)
		game->data.img = mlx_xpm_file_to_image(game->data.mlx, "../textures/wall_n.xpm", &game->data.img_width, &game->data.img_height);
	else if (game->wdir == DIR_S)
		game->data.img = mlx_xpm_file_to_image(game->data.mlx, "../textures/wall_s.xpm", &game->data.img_width, &game->data.img_height);
	else
		game->data.img = mlx_xpm_file_to_image(game->data.mlx, "../textures/wall_w.xpm", &game->data.img_width, &game->data.img_height);
}
...
void render(t_game *game)
{
	...
	while(game->laser.x < S_X)
	{
		...
		game->laser.x++;
		draw_wall(game, wall_color[game->wdir]);
	}
